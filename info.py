...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002037872585').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wehif99110:IRov87t5mR0h9pgS@cluster0.oxi51.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://nofidih339:7L2uvkTIrbTHfJan@cluster0.swjyd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'urlshortx.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '258b5bce20761997a331394f96441968ac5f852c')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://Dev77_xD')
...
TUTORIAL = environ.get('TUTORIAL', 'https://Dev77_xD') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.

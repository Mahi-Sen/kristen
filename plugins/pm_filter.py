...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if not free_trial_status:            
            ...
            new_text= "**🤣 ʏᴏᴜ ᴀʟʀᴇᴀᴅʏ ᴜꜱᴇᴅ ꜰʀᴇᴇ ɴᴏᴡ ɴᴏ ᴍᴏʀᴇ ꜰʀᴇᴇ ᴛʀᴀɪʟ. ᴘʟᴇᴀꜱᴇ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ʜᴇʀᴇ ᴀʀᴇ ᴏᴜʀ please buy subscription here are our 👉 /plans**"
            await query.message.edit_text(text=new_text)
            return
     ...
     #   if not search:
      ...
      #      return
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("✅ ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ ✅", url="https://t.me/+KzbVzahVdqQ3MmM1")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
            ...
            InlineKeyboardButton("✅ ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ ✅", url="https://t.me/vj_bots")
        ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @kingvj01
       ...
       await query.message.edit_media(
        ...
        buttons = [[
	    InlineKeyboardButton('♻️ ʀᴇꜰʀᴇꜱʜ ♻️', callback_data='start'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='help')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        if len(message.text) < 100:
            ...
            if not files:
                if settings["spell_check"]:
                    ...
                    return await reply_msg.edit_text(f"**⚠️ ᴍᴀᴋᴇ ꜱᴜʀᴇ ꜱᴘᴇʟʟɪɴɢ ɪꜱ ᴄᴏʀʀᴇᴄᴛ. - {name}**")
        else:
            return
    else:
